  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="space-y-0.5">
              <p className="text-[11px] font-bold tracking-wide uppercase text-cozy-night-100/50 dark:text-cozy-cream-200/40 leading-none">
                System Sync
              </p>
              <p className="text-xs font-semibold text-cozy-night-300 dark:text-white leading-tight">
                {statusText}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="p-1 rounded-lg bg-white/10 hover:bg-white/20 transition-colors text-cozy-night-100/50 dark:text-cozy-cream-200/40"
        ...
        {queueLength > 0 && (
          <p className="text-[10px] text-cozy-night-100/60 dark:text-cozy-cream-200/50 leading-relaxed font-semibold bg-sky-500/10 border border-sky-500/20 rounded-lg py-1 px-2.5 flex items-center gap-1">
        ...
        {isExpanded && (
          <motion.div
            ...
            className="border-t border-cozy-cream-300/30 dark:border-cozy-night-100/10 pt-3 space-y-2 text-[11px] overflow-hidden"
          >
            <div className="flex justify-between items-center text-cozy-night-100/60 dark:text-cozy-cream-200/50 font-medium">
              ...
              <button
                ...
                className={`py-1 px-2.5 rounded-lg font-bold text-[9px] uppercase tracking-wider transition-all duration-300 border ${
                  syncState.isSimulated
                    ...
                    : 'bg-white/10 border-white/20 text-cozy-night-100/50 dark:text-cozy-cream-200/40 hover:bg-white/20'
                }`}
              >
