      ...
      try {
        ...
        if (active) {
          ...
          try {
            ...
            console.warn('Failed recommendations fetch:', recErr);
          } finally {
    ...
    <div className="relative min-h-screen pb-16">
      ...
      <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-8 relative z-10">
        ...
        <div className="flex justify-between items-center">
          ...
          <button 
            ...
            className={`px-4 py-2.5 rounded-xl border flex items-center gap-2 text-xs font-bold uppercase tracking-wider shadow-sm transition-all ${
              isSaved 
                ? 'bg-cozy-amber/15 border-cozy-amber/30 text-cozy-amber hover:bg-cozy-amber/25'
                : 'bg-white/20 dark:bg-white/5 border-white/20 dark:border-white/10 hover:bg-white/30 hover:text-cozy-amber'
            }`}
          >
            {isSaved ? (
              <>
        ...
        <div className="glass-panel border-white/20 dark:border-white/5 rounded-3xl p-6 sm:p-8 space-y-5 relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-tr from-cozy-amber/10 to-cozy-lavender/5 rounded-full blur-3xl pointer-events-none" />

          <div className="flex flex-wrap gap-2 items-center">
            {paperDetails.fields && paperDetails.fields.map((field, idx) => (
              <span key={idx} className="px-3 py-1 rounded-full bg-cozy-amber/15 dark:bg-cozy-amber-light/10 text-cozy-amber dark:text-cozy-amber-light text-[10px] font-bold uppercase tracking-widest">
                {field}
              </span>
            ))}
            <span className="px-2.5 py-0.5 rounded-md bg-white/25 dark:bg-white/5 border border-white/10 text-[10px] text-cozy-night-100/50 dark:text-cozy-cream-200/40 font-semibold uppercase tracking-wider">
              {paperDetails.source || 'Semantic Scholar API'}
            </span>
          </div>

          <div className="space-y-3">
            <h1 className="font-serif font-bold text-2xl sm:text-3xl text-cozy-night-300 dark:text-white leading-tight max-w-5xl">
              {paperDetails.title}
            </h1>
            
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-cozy-night-100/60 dark:text-cozy-cream-200/50 font-serif">
              <span className="font-bold underline decoration-cozy-amber/40">
          ...
          {/* Quick Metrics grid */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-3 border-t border-cozy-cream-300/40 dark:border-cozy-night-100/10">
            
            <div className="bg-black/5 dark:bg-white/5 p-3 rounded-2xl border border-white/5 flex items-center gap-3">
              <div className="p-2 rounded-xl bg-cozy-amber/10 text-cozy-amber">
                <Quote className="w-5 h-5" />
              </div>
              <div>
                <span className="text-[10px] font-bold text-cozy-night-100/40 dark:text-cozy-cream-200/35 uppercase tracking-widest block">Total Citations</span>
                <span className="font-sans font-bold text-base text-cozy-night-300 dark:text-white">
            ...
            <div className="bg-black/5 dark:bg-white/5 p-3 rounded-2xl border border-white/5 flex items-center gap-3">
              ...
              <div>
                <span className="text-[10px] font-bold text-cozy-night-100/40 dark:text-cozy-cream-200/35 uppercase tracking-widest block">Impact Rating</span>
                <span className="font-sans font-bold text-base text-cozy-night-300 dark:text-white">
            ...
            <div className="bg-black/5 dark:bg-white/5 p-3 rounded-2xl border border-white/5 flex items-center gap-3">
              ...
              <div>
                <span className="text-[10px] font-bold text-cozy-night-100/40 dark:text-cozy-cream-200/35 uppercase tracking-widest block">Access Status</span>
                <span className="font-sans font-bold text-base text-cozy-night-300 dark:text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="glass-panel border-white/20 dark:border-white/5 rounded-3xl p-6 sm:p-8 space-y-4">
              <h3 className="font-serif font-bold text-xl text-cozy-night-300 dark:text-white flex items-center gap-2">
                <FileText className="w-5 h-5 text-cozy-amber" />
                <span>Abstract synopsis</span>
              </h3>
              <p className="font-serif text-sm sm:text-base leading-relaxed text-cozy-night-100/75 dark:text-cozy-cream-200/70 text-justify border-l-2 border-cozy-amber/20 pl-4 py-1">
            ...
            <div className="glass-panel border-white/20 dark:border-white/5 rounded-3xl p-6 sm:p-8 space-y-5">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border-b border-cozy-cream-300/40 dark:border-cozy-night-100/10 pb-4">
                ...
                {paperDetails.pdf_url && (
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-cozy-amber hover:brightness-110 text-white text-xs font-bold transition-all shadow-sm"
                  >
              ...
              {paperDetails.pdf_url ? (
                <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-cozy-night-400/50 h-[500px]">
                  {!iframeError ? (
                    <iframe
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center space-y-4">
                      <HelpCircle className="w-12 h-12 text-cozy-amber/50" />
                      <h4 className="font-serif font-bold text-lg">Frame Embedding Restriction</h4>
                      <p className="text-xs text-cozy-night-100/50 dark:text-cozy-cream-200/40 max-w-md">
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer" 
                        className="px-5 py-2 rounded-xl bg-cozy-amber text-white font-bold text-xs"
                      >
                        Open PDF in New Tab
                      </a>
                    </div>
                ...
                <div className="p-8 text-center rounded-2xl bg-black/5 dark:bg-white/5 border border-dashed border-cozy-cream-300/40 dark:border-cozy-night-100/10 space-y-4">
                  <AlertCircle className="w-12 h-12 text-cozy-amber/50 mx-auto" />
                  <h4 className="font-serif font-bold text-lg">Subscription Access Gate</h4>
                  <p className="text-xs text-cozy-night-100/50 dark:text-cozy-cream-200/40 max-w-md mx-auto leading-relaxed">
          ...
          <div className="space-y-8">
            ...
            <div className="glass-panel border-white/20 dark:border-white/5 rounded-3xl p-6 space-y-5">
              <h3 className="font-serif font-bold text-lg text-cozy-night-300 dark:text-white flex items-center gap-2 pl-1 border-b border-cozy-cream-300/40 dark:border-cozy-night-100/10 pb-3">
                <Sparkles className="w-4 h-4 text-cozy-amber" />
                <span>Related Research Studies</span>
              </h3>

              {loadingRecs ? (
                <div className="py-6 text-center">
                  <RefreshCw className="w-6 h-6 text-cozy-amber animate-spin mx-auto" />
                </div>
              ) : recommendations.length === 0 ? (
                <p className="text-xs text-cozy-night-100/40 dark:text-cozy-cream-200/40 pl-1">
                ...
                <div className="space-y-4">
                  {recommendations.map((rec) => (
                    <Link 
                      key={rec.id} 
                      to={`/paper/${rec.id}`}
                      className="p-3.5 rounded-2xl bg-black/5 dark:bg-white/5 border border-white/5 hover:border-cozy-amber/30 hover:bg-black/10 dark:hover:bg-white/10 transition-all flex flex-col space-y-2 group block"
                    >
                      <h4 className="font-serif font-bold text-xs text-cozy-night-300 dark:text-white leading-snug group-hover:text-cozy-amber transition-colors line-clamp-2">
                        {rec.title}
                      </h4>
                      <div className="flex justify-between items-center text-[10px] text-cozy-night-100/50 dark:text-cozy-cream-200/45">
            ...
            <div className="glass-panel border-white/20 dark:border-white/5 rounded-3xl p-6 space-y-3.5">
              <h4 className="font-serif font-bold text-sm text-cozy-night-300 dark:text-white pl-1">
                Scholarly Citing Reference
              </h4>
              <p className="text-[11px] text-cozy-night-100/60 dark:text-cozy-cream-200/50 leading-relaxed pl-1">
                To cite this paper in your bibliographies:
              </p>
              
              <div className="p-3 rounded-xl bg-black/10 dark:bg-white/5 border border-white/5 select-all text-[10px] font-mono leading-relaxed text-cozy-night-100/75 dark:text-cozy-cream-200/70 break-words">
